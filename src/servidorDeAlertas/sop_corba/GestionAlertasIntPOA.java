                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // sop_corba/GestionAlertasInt/buscarPaciente
       {
         ...
         servidorDeAlertas.sop_corba.PacienteDTOHolder objPacienteResultado = new servidorDeAlertas.sop_corba.PacienteDTOHolder ();
         boolean $result = false;
         $result = this.buscarPaciente (numeroHabitacion, objPacienteResultado);
         out = $rh.createReply();
         out.write_boolean ($result);
         servidorDeAlertas.sop_corba.PacienteDTOHelper.write (out, objPacienteResultado.value);
         break;
       }
